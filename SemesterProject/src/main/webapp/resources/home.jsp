...
<svg width="160" height="40">
	<rect width="160" height="40" fill="white" stroke-width="1" stroke="black"/>
	<!-- TODO: get text from file and turn red if error -->
...
<svg width="170" height="40">
	<rect width="170" height="40" fill="white" stroke-width="1" stroke="black"/>
	<!-- TODO: get text from file and turn red if error -->
	<text fill="000000" font-size="15" font-family="Times New Roman" x="15" y="23">STRAWBERRYFIELDS</text>
</svg>
<svg width="90" height="40">
	<rect width="90" height="40" fill="white" stroke-width="2" stroke="black"/>
